...
export default class BoatMap extends LightningElement {
  ...
  //public so decorate with @api - public properties are reactive = component rerenders
  @api error = undefined;
  @api mapMarkers = [];
  ...
  // Wire the getRecord method using ('$boatId') instead of '$recordId'
